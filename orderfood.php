...
<div class="container">
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            ...
            <div class="card-body">
                <form action="orderinsert.php" style="max-width:500px;margin:auto" method="post">
...
<!--                                    <select style="width: 115px" name="amount" id="a">-->
<!--                                        <option>amount</option>-->
<!---->
<!--                                        --><?php //while($row=mysqli_fetch_array($res1)):;?>
<!--                                            <option type="text" name=food" value="--><?php //echo $row['amount'];?><!--">--><?php //echo $row['amount'];?><!--</option>-->
<!--                                        --><?php //endwhile;?>
<!--                                    </select>-->
<!--                                </div>-->
<!--                            </td>-->
