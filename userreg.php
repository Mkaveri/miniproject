...
<head>
    ...
    <style>
        ...
        * {box-sizing:border-box;}
        ...
        body{
            margin:0;
            background:url("images/bengalkatzen.jpg") no-repeat;
...
$sql = "INSERT INTO oldcustomer(cname,petname,numberofpets)
values('$cname','$petname','$numberofpets')";
...
<div class="card">
    ...
    <form action="userfinal.php" style="max-width:500px;margin:auto" method="post">
